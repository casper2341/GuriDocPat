...
data class Availability(
    ...
    val date: String = "",                  // The date of availability in "yyyy-MM-dd" format
    val workingHoursStart: Date = Date(),   // Doctor's start time for that day
    val workingHoursEnd: Date = Date(),     // Doctor's end time for that day
    val availableSlots: List<TimeSlot> = emptyList(), // List of available time slots
    ...
    val maxPatients: Int = 1,               // Max number of patients per session
